  ...
  describe('TC-058 — invariants', () => {
    it('always returns a well-formed range with startLine ≤ endLine', () => {
      ...
      const cases: SelectionMadePayload[] = [
        ...
        selection({
          blockLineRange: { start: 3, end: 3 },
          selectedText: 'emphasis',
          textBeforeSelection: 'paragraph one with ',
          containerKind: 'paragraph',
        }),
        selection({
          blockLineRange: { start: 5, end: 6 },
          selectedText: 'alpha',
          textBeforeSelection: 'list item ',
          containerKind: 'list-item',
        }),
        selection({
          blockLineRange: { start: 8, end: 10 },
          selectedText: 'A-->B',
          containerKind: 'mermaid',
        }),
        selection({
          blockLineRange: { start: 12, end: 12 },
          selectedText: 'body',
          containerKind: 'html-block',
        }),
      ];
